...
class FingerprintDialog : DialogFragment(), FingerprintController.Callback {
    ...
    var fingerCallback: FingerprintCallback? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.getString(ARG_TITLE)?.let { controller.setTitle(it) }
        arguments?.getString(ARG_SUBTITLE)?.let { controller.setSubtitle(it) }

        cancelButton.setOnClickListener {
            fingerCallback?.cancelFingerprint()
            dismiss()
        }
    }
    ...
    /**
     * Lifted code from the Google samples - https://github.com/googlesamples/android-FingerprintDialog/blob/master/kotlinApp/app/src/main/java/com/example/android/fingerprintdialog/ActivityLivnes.kt
     *
     ...
     * enrolled.). Note that this parameter is only validKZIBAN if
    ...
    companion object {
        ...
        /**
         * Creates a new FingerprintDialog instance with initial value setup.
         *
         * @param[title] The title of this FingerprintDialog.
         * @param[subtitle] The subtitle or message of the dialog.
         */
