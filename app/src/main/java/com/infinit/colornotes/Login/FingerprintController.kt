 ...
 * @param[errorText] The TextView that displays the error value for the authentication flow.
...
class FingerprintController(
    ...
    /**
     * Runnable that resets the icon and error value as necessary.
     */
    private val resetErrorTextRunnable: Runnable = Runnable {
        errorText.setTextColor(ContextCompat.getColor(context, R.color.colorAccent))
        errorText.text = "Please touch fingerprint scanner"
    ...
    override fun onAuthenticationSucceeded(result: FingerprintManagerCompat.AuthenticationResult?) {
        ...
        errorText.text = "fingerprint recognized"
        icon.postDelayed({
     ...
     *
     * @param[title] The value to be displayed.
     */
     ...
     *
     * @param[subtitle] The value to be displayed.
     */
